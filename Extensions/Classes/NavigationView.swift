...
import UIKit
let NavBlackImage:UIImage = UIImage(named: "icon_back")!
...
public class NavigationView: UIView {
    ...
    @IBOutlet public weak var rightButtonHeight: NSLayoutConstraint!
    @IBOutlet public weak var rightButtonBottom: NSLayoutConstraint!
    @IBOutlet public weak var rightButton2Width: NSLayoutConstraint!
    ...
    @objc public func setRightBlueButtonTitle(_ title: String, target: Any, action: Selector) {
        ...
        rightButtonHeight.constant = 44
        rightButtonBottom.constant = 0
    }
